...
from data.data_loader_ss_dcc_0 import ImageDataset
...
args.best_epoch = -1
checkpoint_save_dir = '/home/rainkeeper/Projects/PycharmProjects/rain24/checkpoints_rain24_ss_dcc_0_0_try0'
...
def train(train_image_dir_distance, train_image_dir_crowd_count, model, criterion, optimizer, epoch):
    ...
    for i, (imgs, img_name) in enumerate(train_loader):
        ...
        distance_and_count = model(images)      # 定义: 人越小，distance越小
