...
args.best_epoch = -1
checkpoint_save_dir = '/home/rainkeeper/Projects/PycharmProjects/rain24/checkpoints_rain24_fs_dcc_1_0_10p_try9'
...
def main():
    ...
    args.model_path = '/home/rainkeeper/Projects/PycharmProjects/rain24/checkpoints_rain24_ss_dcc_1_0_try0/checkpoint_49_0.993749237711916_0.9962952799121844_0.9254823685961411_0.9754491017964072.pth.tar'
    train_image_dir = '/home/rainkeeper/Projects/Datasets/few_shot/shanghaiTech_few_shot' + str(
        args.dataset_id) + '/part_' + args.dataset + '/train_image10'
    train_gt_dir = '/home/rainkeeper/Projects/Datasets/few_shot/shanghaiTech_few_shot' + str(
        args.dataset_id) + '/part_' + args.dataset + '/train_gt10'
    test_image_dir = '/home/rainkeeper/Projects/Datasets/few_shot/shanghaiTech_few_shot' + str(
        args.dataset_id) + '/part_' + args.dataset + '/test_image'
    test_gt_dir = '/home/rainkeeper/Projects/Datasets/few_shot/shanghaiTech_few_shot' + str(
        args.dataset_id) + '/part_' + args.dataset + '/test_gt'
    ...
    for epoch in range(args.start_epoch, args.start_epoch + args.epochs):
        train_mae, train_mse, train_gt_sum, train_predict_sum = train(train_image_dir, train_gt_dir, model, criterion,
                                                                      optimizer, epoch)
