...
args.best_epoch = -1
checkpoint_save_dir = '/home/rainkeeper/Projects/PycharmProjects/rain24/checkpoints_rain24_fs_dcc_0_0_5p_try6'
...
def main():
    ...
    train_image_dir = '/home/rainkeeper/Projects/Datasets/few_shot/shanghaiTech_few_shot' + str(args.dataset_id) + '/part_' + args.dataset + '/train_image5'
    train_gt_dir = '/home/rainkeeper/Projects/Datasets/few_shot/shanghaiTech_few_shot' + str(args.dataset_id) + '/part_' + args.dataset + '/train_gt5'
