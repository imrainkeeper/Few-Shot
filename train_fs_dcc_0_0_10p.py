...
args.best_epoch = -1
checkpoint_save_dir = '/home/rainkeeper/Projects/PycharmProjects/rain24/checkpoints_rain24_fs_dcc_0_0_10p_try6'
...
def main():
    ...
    args.model_path = '/home/rainkeeper/Projects/PycharmProjects/rain24/checkpoints_rain24_ss_dcc_0_0_try0/checkpoint_34_0.9872240517136236_0.9874862788144896_0.8190286094477711_0.8973053892215569.pth.tar'
    train_image_dir = '/home/rainkeeper/Projects/Datasets/few_shot/shanghaiTech_few_shot' + str(args.dataset_id) + '/part_' + args.dataset + '/train_image10'
    train_gt_dir = '/home/rainkeeper/Projects/Datasets/few_shot/shanghaiTech_few_shot' + str(args.dataset_id) + '/part_' + args.dataset + '/train_gt10'
